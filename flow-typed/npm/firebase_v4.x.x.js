// flow-typed signature: 3c901e30392ba503cc8433f94fecb2cc
// flow-typed version: b43dff3e0e/firebase_v4.x.x/flow_>=v0.34.x
...
declare class Auth {
  ...
  onAuthStateChanged(
    nextOrObserver: (?FirebaseUser) => Promise<void>,
  ...
  signInAndRetrieveDataWithCredential(credential: AuthCredential): Promise<FirebaseUserCredential>,
  ...
  signInWithPopup(AuthProvider): Promise<?FirebaseUserCredential>,
...
declare class FirebaseUser extends FirebaseUserInfo {
  ...
  linkAndRetrieveDataWithCredential(credential: AuthCredential): Promise<FirebaseUserCredential>,
  ...
  updateProfile(profile: FirebaseUserProfile): Promise<void>
}
...
declare type OAuthProvider = FacebookAuthProvider | GithubAuthProvider | GoogleAuthProvider | TwitterAuthProvider;

/** **** database ******/
declare type FirebaseValue = any;
declare type OnCompleteCallback = (error: ?Object) => void;
declare type QueryEventType = 'value' | 'child_added' | 'child_changed' | 'child_removed' | 'child_moved';
...
declare class Query {
  ...
  off(eventType?: QueryEventType, callback?: FirebaseDatabaseCallback, context?: Object): void,
  on(
...
declare class Reference extends Query {
  ...
  push(value?: FirebaseValue, onComplete?: OnCompleteCallback): ThenableReference & Promise<void>,
  remove(onComplete?: OnCompleteCallback): Promise<void>,
  set(value: FirebaseValue, onComplete?: OnCompleteCallback): Promise<void>,
